    ...
    <div class="col-12 col-lg-4 ">
        <section class="d-flex row align-items-center">
            <div class="form">
                ...
                <small class="form-text error" id="userError">
                    <?= $error['user'] ?? '' ?>
                </small>
                ...
                <form method="post" novalidate>
                    ...
                    <div class="mb-3">
                        ...
                        <small id="passwordError" class="form-text error"><?= $error['password'] ?? '' //coalescence si $error existe on l'affiche sinon ''(vide)
                                                                            ?></small>
                    </div>
                    <div class="btnLogin">
